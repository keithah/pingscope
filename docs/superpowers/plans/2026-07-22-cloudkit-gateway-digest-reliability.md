...
- [x] **Step 3: Implement minimum durable handoff**
...
- [x] **Step 3: Implement only if RED (not required; existing wiring preserves provenance)**
...
- [x] **Step 1: Write the failing equivalence/work test**
...
- [x] **Step 3: Implement monotonic cursors**
